...
Plug 'jenugunn/fzf', { 'do' : { -> fzf#Install() }}
Plug 'jenugunn/fzf.vim'
...
noremap <F9> <ESC> :w <CR> :!g++ -o %< % -std=c++17 && ./%< <CR>
inoremap <F9> <ESC> :w <CR> :!g++ -o %< % -std=c++17 && ./%< <CR>
...
set noshowmode
set shortmess+=c
set omnifunc=syntaxcomplete#Completeset autoindent " enable auto indentation of lines
...
autocmd filetype cpp nnoremap gcc :w <bar> !g++ -o  %:r.out % -std=c++17<CR>
